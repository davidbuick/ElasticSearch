...
public class AmazonKinesisSample {
    ...
    private static void init() throws Exception {
         ...
         * (/home/local/ANT/waha/.aws/credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/home/local/ANT/waha/.aws/credentials), and is in valid format.",
                    e);
        }
        ...
        for (int j = 0; j < 10; j++) {
           ...
           // putRecordRequest.setSequenceNumberForOrdering(sequenceNumberForOrdering);
            ...
            System.out.println("Successfully putrecord, partition key : " + putRecordRequest.getPartitionKey()
                    + ", ShardID : " + putRecordResult.getShardId() + " sequenceNum: " + putRecordResult.getSequenceNumber());
        }
